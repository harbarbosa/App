...
app_hooks()->add_filter('app_filter_staff_left_menu', function ($sidebar_menu) {
                ...
                $catalogo_submenu["composicao"] = array("name" => "Composicao", "url" => "composicao");
                $catalogo_submenu["insumos"] = array("name" => "Insumos", "url" => "items");
        

            if (count($catalogo_submenu)) {
                $sidebar_menu["Catalogo"] = array("name" => "Catalago", "url" => "demo", "class" => "book-open", "position" => 3, "submenu" => $catalogo_submenu);
            }
