...
class Tasks extends Security_Controller {
    ...
    public function get_context_id_pairs() {
        return array(
    ...
    public function can_create_tasks($_context = null) {
    ...
    public function _can_edit_project_tasks($project_id) {
    ...
    public function can_view_tasks($context = "", $context_id = 0, $task_info = null) {
        if ($task_info) {
    ...
    public function _can_delete_project_tasks($project_id) {
        //check if the user has permission to edit tasks of this project
    ...
    public function _get_accessible_contexts($type = "create", $task_info = null) {
    ...
    public function get_removed_task_status_ids($project_id = 0) {
        if (!$project_id) {
            return "";
        }
    ...
    public function _get_task_related_dropdowns($context = "", $context_id = 0, $return_empty_context = false) {
    ...
    public function _get_project_deadline_for_task($project_id = 0) {
        if (!$project_id) {
            return "";
        }
    ...
    public function _get_milestones_dropdown_list($project_id = 0) {
    ...
    public function _get_priorities_dropdown_list($priority_id = 0) {
        $priorities = $this->Task_priority_model->get_details()->getResult();
    ...
    public function _get_project_members_dropdown_list($project_id = 0) {
        if ($this->login_user->user_type === "staff") {
