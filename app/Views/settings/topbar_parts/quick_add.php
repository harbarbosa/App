...
if ($login_user->user_type == "staff" && get_setting("module_project_timesheet") == "1") {
    $links .= modal_anchor(get_uri("projects/diario_form"), app_lang('add_project_time'), array("class" => "dropdown-item clearfix", "title" => app_lang('add_project_time'), "id" => "js-quick-add-project-time"));
}
