...
<?php echo form_open(get_uri("estimates/save_item_orcamento"), array("id" => "estimate-item-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                <label for="estimate_p_unit" class=" col-md-3">Preço</label>
                <div class="col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "estimate_p_unit",
                        "name" => "estimate_p_unit",
                        "value" => $model_info->p_total ? 'R$ '.to_decimal_format($model_info->p_unit) : "",
