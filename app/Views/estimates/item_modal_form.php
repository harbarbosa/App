...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                <label for="estimate_item_etapa" class=" col-md-3">Etapa</label>
                <div class="col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "estimate_item_etapa",
                        "name" => "estimate_item_etapa",
                        "value" => $model_info->etapa_nome,
                        "class" => "form-control validate-hidden",
                        "placeholder" => app_lang('select_or_create_new_item'),
                        "data-rule-required" => true,
                        "data-msg-required" => app_lang("field_required"),
                    ...
                    ?>
                    <a id="estimate_item_etapa_dropdwon_icon" tabindex="-1" href="javascript:void(0);" style="color: #B3B3B3;float: right; padding: 5px 7px; margin-top: -35px; font-size: 18px;"><span>×</span></a>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="row">
                <label for="estimate_bdi" class=" col-md-3">BDI</label>
                <div class="col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "estimate_bdi",
                        "name" => "estimate_bdi",
                        "value" => $model_info->rate ? to_decimal_format($model_info->bdi) : "",
                        "class" => "form-control ",
                        "placeholder" => 'BDI',
                        "data-rule-required" => true,
                        "data-msg-required" => app_lang("field_required"),
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#estimate_item_etapa_dropdwon_icon").click(function () {
            applySelect2OnItemEtapa();
        })
    ...
    function applySelect2OnItemEtapa() {
        $("#estimate_item_etapa").select2({
            ...
            ajax: {
                ...
                quietMillis: 250,
                data: function (term, page) {
                    var estimateId = $("input[name='estimate_id']").val();
                    return {
                        q: term, // search term
                        estimate_id: estimateId // passando estimate_id
                    };
                },
                results: function (data, page) {
                    return {results: data};
