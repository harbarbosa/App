...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                <label for="estimate_titulo" class=" col-md-3">Titulo</label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "titulo",
                        "name" => "titulo",
                        "value" => $model_info->titulo ? $model_info->titulo : "",
                        "class" => "form-control",
                        "placeholder" => "Titulo"
                    ));
                    ?>
        ...
        <div class="form-group">
            <div class="row">
                <label for="tax_id" class="col-md-3">Imposto Produtos</label>
                <div class="col-md-9">
                    <?php
                    // Verifica se a variável $model_info->tax_id2 está vazia e define o valor padrão
                    $selected_tax = !empty($model_info->tax_id) ? $model_info->tax_id : 2;

                    echo form_dropdown(
                        "tax_id", // Nome do campo
                        $taxes_dropdown, // Opções do dropdown
                        $selected_tax, // Valor pré-selecionado
                        "class='select2 tax-select2'" // Classes adicionais
                    );
                    ?>
                    </div>
                </div>
        ...
        <div class="form-group">
            <div class="row">
                <label for="tax_id" class="col-md-3">Imposto Serviços</label>
                <div class="col-md-9">
                    <?php
                    // Verifica se a variável $model_info->tax_id2 está vazia e define o valor padrão
                    $selected_tax = !empty($model_info->tax_id2) ? $model_info->tax_id2 : 1;

                    echo form_dropdown(
                        "tax_id2", // Nome do campo
                        $taxes_dropdown, // Opções do dropdown
                        $selected_tax, // Valor pré-selecionado
                        "class='select2 tax-select2'" // Classes adicionais
                    );
        ...
        <div class="form-group">
            <div class="row">
                <label for="tax_id" class=" col-md-3">Comissão de Venda</label>
                <div class="col-md-9">
                    <?php
                    echo form_dropdown("tax_id3", $taxes_dropdown, array($model_info->tax_id2), "class='select2 tax-select2'");
                    ?>
                </div>
            </div>
        </div>
