        ...
        <div class="row">
            <div class="col-md-12">
                <div class="project-title-section">
                    ...
                    <ul id="project-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs rounded classic mb20 scrollable-tabs border-white" role="tablist">
                        ...
                        if ($login_user->user_type === "staff") {
                            ...
                            $project_tabs["materiais"] = "projects/materiais/" . $project_info->id;
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="project-materiais-section"></div>
                    <div role="tabpanel" class="tab-pane fade" id="project-timesheets-section"></div>
                    <div role="tabpanel" class="tab-pane fade" id="project-diario_obra-section"></div>
